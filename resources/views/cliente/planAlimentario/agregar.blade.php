...
@section('content')
@if (count($na) > 0 && count($comida) > 0 && count($fac) > 0 && count($grupos) > 0)
...
<div class="row col-lg-10 offset-lg-1">
	<div class="fullDiv text-center">
	<span class="display-5">Tabla de equivalencias en la cocina</span>
</div>
<table class="table table-bordered  table-hover">
	<tbody>
		<tr>
			<th scope="row" class="">Tazón</th>
			<td>taza de desayuno</td>
			<td>250 gr</td>
		...
		<tr>
			<th scope="row">Cucharada</th>
			<td> cucharada sopera</td>
			<td>20gr</td>
			<th scope="row">Cucharadita</th>
			<td> cucharada de postre</td>
			<td>5gr</td>
		</tr>
		<tr>
			<th scope="row">Vaso </th>
			<td>vaso de de agua</td>
			<td>200gr</td>
			<th scope="row">Vacito </th>
			<td>vaso de vino</td>
			<td>100gr</td>
		</tr>
	</tbody>
	...
	<section id="buscarAlimento" class="bk_blanco text-center">
		...
		<div id="bodySearch" class="p-3 rblSolid">
			...
			<div class="fullDiv text-center pb-4">
				...
				<div class="display-4">
					Registra un nuevo progreso, si el problema continua contacta a tu nutricionista para que defina los valores requeridos.
				</div>
			</div>
			@endif
			@endsection

...
@section('title','Administrar categorias alimentarias') 
...
@endsection  
@section('placeholderBuscar','Buscar categoria') 
...
<div class="p-3">
   {{ Form::model($categoria,['route' => ['categoriasalimentarias.update',$categoria->id], 'method'=>'PUT']) }}
<div class="text-center mb-4 mt-3">
    <span class="display-4">Modificar<strong> categoria</strong>
    </span>
</div>
<hr>

...
<hr>
{!! Form::model($nutricionista,['route' => ['agregarNutricionistas.store',$nutricionista->id], 'method' => 'PUT','files'=> true]) !!}
    ...
    <div class="row">
        <div class="col-sm-8 offset-sm-2 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4 mt-4 mb-5 pl-5 pr-5">
            <button type="submit" class="btn btn-primary fullDiv">
                <i class="fa fa-user" aria-hidden="true"></i> Modificar nutricionista
            </button>
        </div>
    </div>
{!! Form::Close() !!}

<div class="row">
	...
	<div class="col-sm-4 col-lg-4">
		...
		<div class="form-group" >
			...
			{{ Form::file('us_img_carnet_f',['class'=>'imagen']) }}

		</div>
		<div class="form-group">
			{{ Form::label('us_img_carnet_p','Foto de carnet posterior') }}<br>
			{{ Form::file('us_img_carnet_p',['class'=>'imagen']) }}
		</div>
		<div class="form-group">
			{{ Form::label('us_img_titulo','Foto de titulo') }}<br>
			{{ Form::file('us_img_titulo',['class'=>'imagen']) }}
		</div>
		<div class="form-group">
			{{ Form::label('us_fecha_caducacion','Fecha de caducacion') }}
			{{ Form::date('us_fecha_caducacion',null,['class' =>'form-control',
										     		  'required']) }}
		</div>		

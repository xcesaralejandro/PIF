<div class="row ">
	<div class="col-sm-6  col-lg-6 col-xl-3 ">
		<div class=" form-group ">
			{{ Form::label('ga_id',' ') }}
			{{ Form::select('ga_id',$grupos,$gActual,['class' => ' fullDiv chosen-select ','required', 'id'=>'grupos', 'placeholder'=>'']) }}
		</div>
	</div>
	<div class="col-sm-6  col-lg-6  col-xl-3">
		<div class="form-group  ">
			{{ Form::label('ct_id',' ') }}
			{{ Form::select('ct_id',$categorias,$cActual,['class' => ' chosen-select','required', 'id '=>'categorias','placeholder'=>'']) }}
		</div>
	</div>
